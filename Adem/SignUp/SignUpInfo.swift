...
class UserInfo: UIViewController, UITextFieldDelegate {
	...
	@objc func handelNext()
	{
		...
		let dataToSave: [String: Any] = ["FirstName": firstName, "LastName": lastName, "UserName": userName, "Email": email, "Password": password]
	...
	// create the alert
	let alert = UIAlertController(title: "User already exist", message: "This email is alread in use. ", preferredStyle: UIAlertController.Style.alert)
	...
	*/
	...
	func textFieldShouldReturn(_ textField: UITextField) -> Bool {
		...
		//		let textFields = [firstNameTextField, lastNameTextField,userNameTextField,emailTextField,passwordTextField,confirmPasswordTextField]
		//
	...
	//self.performSegue(withIdentifier: "already LoggedIn", sender: nil)
	}
	}
	*/
	...
	func setuploginFieldView() {
		...
		let userNameImage = UIImage(named:"Knife")
		addLeftImageTo(textField: userNameTextField, addImage: userNameImage!)
		...
		loginFieldView.addSubview(userNameTextSeparator)
		...
		//Username text
		userNameTextField.leftAnchor.constraint(equalTo: loginFieldView.leftAnchor, constant: 12).isActive = true
		userNameTextField.topAnchor.constraint(equalTo: lastNameTextSeparator.topAnchor).isActive = true
		userNameTextField.widthAnchor.constraint(equalTo: loginFieldView.widthAnchor, constant: -24).isActive = true
		userNameTextField.heightAnchor.constraint(equalTo: loginFieldView.heightAnchor, multiplier: 1/6).isActive = true
		//Username separator
		userNameTextSeparator.leftAnchor.constraint(equalTo: loginFieldView.leftAnchor).isActive = true
		userNameTextSeparator.topAnchor.constraint(equalTo: userNameTextField.bottomAnchor).isActive = true
		userNameTextSeparator.widthAnchor.constraint(equalTo: loginFieldView.widthAnchor).isActive = true
		userNameTextSeparator.heightAnchor.constraint(equalToConstant: 1).isActive = true
		
		
		//Email text
		emailTextField.leftAnchor.constraint(equalTo: loginFieldView.leftAnchor, constant: 12).isActive = true
		emailTextField.topAnchor.constraint(equalTo: userNameTextSeparator.topAnchor).isActive = true
