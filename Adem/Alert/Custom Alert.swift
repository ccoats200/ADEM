...
//  Adem
//
//  Created by Coleman Coats on 3/4/19.
...
class addedItemAlert: UIViewController {
	...
	let addedItem: UIView = {
		...
		addedNotification.backgroundColor = UIColor.rgb(red: 30, green: 188, blue: 29).withAlphaComponent(0.95)
	...
	func setuploginFieldView() {
		...
		let alertStackView = UIStackView(arrangedSubviews: [loginButton, addButton])
