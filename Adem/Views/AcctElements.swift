...
class AccountCell: CellBasics {
	...
	var profileItem: accountContent? {
		didSet {
	...
	let profileImageSection: UIImageView = {
		...
		profilepic.layer.borderColor = UIColor.rgb(red: 30, green: 188, blue: 29).cgColor
...
class familyCells: CellBasics {
	...
	let profileImageView: UIImageView = {
		...
		personImage.layer.borderColor = UIColor.rgb(red: 30, green: 188, blue: 29).cgColor
...
class deviceCells: CellBasics {
	...
	let kitchenStaff0: UIButton = {
		...
		Staff0.layer.borderColor = UIColor.rgb(red: 30, green: 188, blue: 29).cgColor
...
class accountAndPrivacyCollectionViewCells: CellBasics {
	...
	let accountAndPrivacy: UIImageView = {
		...
		//aAndp.layer.borderColor = UIColor.rgb(red: 30, green: 188, blue: 29).cgColor
